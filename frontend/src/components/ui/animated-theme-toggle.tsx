...
export const AnimatedThemeToggle = ({ isDark, onToggle, className }: AnimatedThemeToggleProps) => {
  return (
    <button
      onClick={onToggle}
      className={cn('p-1 cursor-pointer', isDark ? 'text-white' : 'text-slate-700', className)}
